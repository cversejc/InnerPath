...
export const calendarMeta = {
  ...
  overview: [
    '这个阶段，你可能会反复琢磨时间怎么分、精力放在哪里、什么值得优先，这很正常。',
    '有些日子看起来动作不多，实际上你正在整理判断、分辨轻重，并为下一步留出空间。'
  ]
}
...
export const phaseDefinitions = [
  {
    ...
    tone: 'yellow',
    statusLabel: '黄灯 · 先记录',
    summary: '想法频繁涌现，先记录、不急着推进。把模糊的念头变成纸上的条目。',
    suitable: ['整理正在犹豫的事情', '记录最近一周的情绪与决定', '听取重要他人的看法，暂不急着拍板'],
    unsuitable: ['同时开启太多新计划', '在情绪里做最终决定', '为了马上见效强行推进'],
  ...
  },
  {
    ...
    tone: 'green',
    statusLabel: '绿灯 · 可推进',
    summary: '表达欲望和执行力逐步抬升，适合把想法写下来，并完成一件可以带来反馈的事。',
    suitable: ['确认当前最重要的目标与步骤', '把想法写成可以执行的行动', '完成一件可以带来反馈的事'],
    unsuitable: ['信息不足时凭冲动开启新题', '下午后反复修改或重做', '临时推翻已经确认的安排'],
  ...
  },
  {
    ...
    suitable: ['记录与整理', '回复搁置消息', '完成不需脑力的收尾工作', '给自己留出安静时间'],
    unsuitable: ['开启重大新计划', '在焦虑里追问结果', '在沟通里强行定方向'],
  ...
  },
  {
    ...
    tone: 'green',
    statusLabel: '绿灯 · 复盘微调',
    summary: '真实感受和结果开始显现，适合做小幅调整，不适合大规模推翻重来。',
    suitable: ['收集身边人的真实感受', '回看最近一段时间的选择与结果', '微调接下来的安排与行动方式'],
    unsuitable: ['急着向所有人证明结果', '因为一次反馈全盘否定自己', '把等待误判成停滞'],
...
const dailyDetails = {
  '2026-09-07': {
    ...
    statusLabel: '黄灯 · 适合准备',
    keyword: '观察',
    suitable: ['把正在思考的事情再读一遍，标记不确定的部分', '重要对话中先听再说', '晚上回看过去一周的选择，只记录不评价'],
    unsuitable: ['做最终决定', '在还没准备好时向外承诺'],
  ...
  '2026-09-08': {
    ...
    statusLabel: '黄灯 → 晚上绿灯',
    keyword: '梳理',
    suitable: ['将正在考虑的事情按“已定 / 待定”重新分类', '把昨晚的复盘整理成一份回顾'],
    unsuitable: ['中午前决定资源如何分配', '回应情绪化对话'],
  ...
  '2026-09-09': {
    ...
    unsuitable: ['做重大决定、写重要文案、开启新计划', '涉及规则或边界的谈判'],
  ...
  '2026-09-11': {
    ...
    statusLabel: '黄灯 → 下午绿灯',
    keyword: '启动',
    suitable: ['下午把想法转成可执行的下一步', '汇总最近一段时间的决策记录', '傍晚客观评估自己当前的进度'],
    unsuitable: ['上午做重要的资源决定', '回应“谁对谁错”的争论'],
  ...
  '2026-09-12': {
    ...
    statusLabel: '绿灯 · 适合推进',
    keyword: '落地',
    suitable: ['推进已经确定的决定，例如安排任务、确认重要事项', '完成搁置的文字或沟通', '晚上对接下来的方向做简短展望'],
    unsuitable: ['信息不充分时做新决定'],
  ...
  '2026-09-13': {
    ...
    statusLabel: '绿灯 → 下午黄灯',
    keyword: '表达',
    suitable: ['上午写下一个想清楚的想法', '写下“我为什么在意这件事”', '下午请合适的人给你真实感受'],
  ...
  '2026-09-14': {
    ...
    statusLabel: '绿灯 → 晚上黄灯',
    keyword: '细化',
    suitable: ['把想法和讨论结果整理成一页清晰的记录', '请朋友或同事给你真实反馈', '傍晚整理最近听到的意见'],
  ...
  '2026-09-15': {
    ...
    statusLabel: '黄灯 → 下午绿灯',
    keyword: '收束',
    suitable: ['确认“这段时间我真正要完成什么”', '完成回复消息、整理文件等事务性工作', '下午处理安排、时间与顺序等轻量决定'],
  ...
  '2026-09-16': {
    ...
    statusLabel: '绿灯 · 适合推进',
    keyword: '推进',
    suitable: ['确认接下来要联系的重要的人', '确定一件事的完成标准', '把犹豫收束成一个可以先试试的版本'],
  ...
  '2026-09-17': {
    ...
    keyword: '交付',
    suitable: ['完成一件已经准备好的重要事项', '确认接下来要联系的人与安排', '上午开启一个可以持续推进的计划'],
    unsuitable: ['拖延已经准备好的行动', '把今天的窗口留给无关紧要的修改'],
    timeWindow: '午时前是本月最后一段高效输出时间，把力气留给真正重要的事。'
  }
}

export const decisionNodes = [
  { date: '9月12日', pillar: '己丑', tone: 'green', type: '重要目标确认、行动细化' },
  { date: '9月15日', pillar: '壬辰', tone: 'yellow-green', type: '事务性扫尾与轻量决策' },
  { date: '9月16日', pillar: '癸巳', tone: 'green', type: '重要沟通、完成标准确认' },
  { date: '9月17日', pillar: '甲午', tone: 'green', type: '行动落地、计划启动' },
  { date: '9月24日', pillar: '辛丑', tone: 'green', type: '资源与长期选择' }
]
