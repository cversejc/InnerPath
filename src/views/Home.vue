...
<style scoped>
.hero {
  min-height: max(640px, calc(100svh - var(--nav-height) - 56px));
  display: flex;
  align-items: center;
  padding: 56px 0 92px;
}
...
.compass-visual {
  ...
  box-shadow: var(--shadow-soft), inset 0 1px 0 rgba(255, 255, 255, 0.64);
...
.compass-ring::after {
  ...
  inset: 18px;
  border-radius: 50%;
  border: 1px solid rgba(217, 186, 98, 0.34);
}
